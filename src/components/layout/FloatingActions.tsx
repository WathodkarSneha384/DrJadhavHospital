  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      <AnimatePresence>
        {showTop && (
          <motion.button
            ...
            onClick={scrollToTop}
            className="group flex h-12 w-12 items-center justify-center rounded-full text-white shadow-lg transition hover:scale-110"
      ...
      <motion.a
        ...
        className="group relative flex h-14 w-14 items-center justify-center rounded-full text-white shadow-lg transition hover:scale-110"
      ...
      {/* WhatsApp button */}
      <motion.a
        href={`https://wa.me/${siteConfig.whatsapp}?text=${encodeURIComponent("Hello, I would like to book an appointment at Dr. Jadhav Piles Laser Centre.")}`}
        target="_blank"
        rel="noopener noreferrer"
        initial={{ opacity: 0, scale: 0.7 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{ delay: 0.1, type: "spring", stiffness: 300, damping: 22 }}
        className="group relative flex h-14 w-14 items-center justify-center rounded-full text-white shadow-lg transition hover:scale-110 animate-pulse-soft"
